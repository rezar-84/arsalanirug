...
export const ui = {
  en: {
    ...
    catalog: {
     ...
     filterBrand: "House", filterRegion: "Region", sortLabel: "Size", sortLargest: "Largest first", sortSmallest: "Smallest first", clearAll: "Clear",    },
  ...
  fa: {
    ...
    catalog: {
     ...
     filterBrand: "خانه", filterRegion: "خاستگاه", sortLabel: "اندازه", sortLargest: "بزرگ‌ترین اول", sortSmallest: "کوچک‌ترین اول", clearAll: "پاک کردن",    },
...
tr: {
    ...
    catalog: {
     ...
     filterBrand: "Marka", filterRegion: "Bölge", sortLabel: "Boyut", sortLargest: "Önce en büyük", sortSmallest: "Önce en küçük", clearAll: "Temizle",    },
  ...
  es: {
    ...
    catalog: {
     ...
     filterBrand: "Casa", filterRegion: "Región", sortLabel: "Tamaño", sortLargest: "Más grandes primero", sortSmallest: "Más pequeñas primero", clearAll: "Limpiar",    },
  ...
  ja: {
    ...
    catalog: {
     ...
     filterBrand: "ブランド", filterRegion: "産地", sortLabel: "サイズ", sortLargest: "大きい順", sortSmallest: "小さい順", clearAll: "クリア",    },
  ...
  de: {
    ...
    catalog: {
     ...
     filterBrand: "Haus", filterRegion: "Region", sortLabel: "Größe", sortLargest: "Größte zuerst", sortSmallest: "Kleinste zuerst", clearAll: "Zurücksetzen",    },
  ...
  ru: {
    ...
    categories: {
      all: "Все ковры", "selected-available-rugs": "Избранные и доступные", "boutique-rugs": "Бутиковые ковры", oushak: "Ушак", "moshk-abad": "Мошк-Абаад", "new-moshk-abad": "Новый Мошк-Абад",
    } satisfies Record<CategorySlug | "all", string>,
  ...
  ar: {
    ...
    categories: {
      all: "كل السجاد", "selected-available-rugs": "مختار ومتاح", "boutique-rugs": "سجاد فاخر", oushak: "أوشاك", "moshk-abad": "موشك آباد", "new-moshk-abad": "موشك آباد الجديد",
    } satisfies Record<CategorySlug | "all", string>,
  ...
  zh: {
    ...
    categories: {
      all: "全部地毯", "selected-available-rugs": "精选现货", "boutique-rugs": "精品地毯", oushak: "乌沙克", "moshk-abad": "莫什克·阿巴德", "new-moshk-abad": "新莫什克·阿巴德",
    } satisfies Record<CategorySlug | "all", string>,
    ...
    catalog: { title: "地毯收藏", intro: "手工编织的地毯，每一件都是独一无二的作品——尺寸与产地已列明，价格请咨询。", empty: "没有符合此选择的地毯。", filterMaterial: "材质", piecesCount: (n: number) => n + " 件", filterBrand: "品牌", filterRegion: "产地", sortLabel: "尺寸", sortLargest: "从大到小", sortSmallest: "从小到大", clearAll: "清除", },
