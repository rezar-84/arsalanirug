...
| --- | --- | --- | --- | --- | --- | --- |
| A1 | Deploy target is a static host/CDN (owner picked "Static host/CDN" 2026-09-01); the "we gonna use dokploy" note from kit install is superseded or complementary | ARSA-006 needs a target | deploy config/runbook aimed at the wrong host | Rezar86 | logged here | 2026-09-01 |
