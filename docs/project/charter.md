...
| Hosting | static host/CDN (Cloudflare Pages-ready: build `npm run build`, output `dist`, Node 22); host-agnostic |
| CI | none yet |
...
| **Ships in** | en, fa |
| **Source language** | en |
| **Writing directions** | bidirectional — fa is RTL (`dir="rtl"`, logical CSS properties throughout) |
