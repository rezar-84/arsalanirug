...
| **Reviews** | `project/reviews/ARSA-###-<stage>.md` | What each role checked and found. | One file per review. | New files |
...
| Column | Rule |
| --- | --- |
| **ID** | `ARSA-###`. Sequential, never reused, never renumbered. |
