...
- Restate the request in one sentence, in your own words. If your restatement and the
  ...
  building.
- Assign or reuse a work item ID (`ARSA-###`) and add it to
...
**Output:** Tier 1 → `project/plans/ARSA-###.md` from `templates/plan.md`.
...
**Output:** Tier 1 → `project/reviews/ARSA-###-design.md`. Tier 2 → findings
...
**Output:** Tier 1 → `project/reviews/ARSA-###-ship.md`. Tier 2 → summarised.
Tier 3 → skipped.
